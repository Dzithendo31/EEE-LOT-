...
int main(void)
{
  ...
  while (1)
  {
	  // Check if the button is pressed
	      ...
	      // Convert littleEndianNumber to a string and display it
	  // Convert and print littleEndianNumber in binary format to the LCD
	        char binaryStr[17]; // Sufficient size for a 16-bit binary number
	        itoa(littleEndianNumber, binaryStr, 2); // Convert to binary string
	        writeLCD(binaryStr);
